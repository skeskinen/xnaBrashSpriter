                        ...
                        foreach (XElement l_key in l_timeLine.Descendants("key")) {
                            ...
                            if (l_key.Descendants("object").Count() > 0) {
                                ...
                                foreach (XElement l_object in l_key.Descendants("object")) {
                                    GetAttributeInt32(l_object, "folder", out l_tmpInt);
                                    p_output.Write(l_tmpInt);

                                    GetAttributeInt32(l_object, "file", out l_tmpInt);
                                    p_output.Write(l_tmpInt);
                                    ...
                                    GetAttributeFloat(l_object, "pivot_x", out l_tmpFloat);
                                    p_output.Write(l_tmpFloat);

                                    GetAttributeFloat(l_object, "pivot_y", out l_tmpFloat, 1.0f);
                                    p_output.Write(l_tmpFloat);
